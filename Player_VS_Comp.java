...
public class Player_VS_Comp extends JPanel implements ActionListener {
        ...
        public Player_VS_Comp ()
        {
            ...
            image = new ImageIcon(getClass().getResource("RopeToUse.png"));
            setLayout(null);
            ...
            imageVik = new ImageIcon(getClass().getResource("VikingGif.gif"));
            labelVik = new JLabel(imageVik);
            labelVik.setBounds(56, 36, 239, 232);
            add(labelVik);
